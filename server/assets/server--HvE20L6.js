...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CpqWSV-Y.js");
...
const manifest = {
  "23762cf4884d3884089b1eb2eb0c3bf4edfca9d0fdbb01581c18b8d9fbd54c9f": {
    ...
    importer: () => import("./devotional.functions-BW_93uGd.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DvN_tFEX.js").then((n) => n.r),
    import("./start-CYCSV2-V.js"),
