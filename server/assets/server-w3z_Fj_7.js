...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-VUjSM2ym.js");
...
const manifest = {
  "482160fb7da9422a30997d8d1edf5b0380db76c51a523de7ff71d0b08feeace3": {
    ...
    importer: () => import("./admin.functions-BzpyWWNj.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CANOqaDn.js").then((n) => n.r),
    import("./start-CtISF-rm.js"),
