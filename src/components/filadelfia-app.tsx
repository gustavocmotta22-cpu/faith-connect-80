...
function GalleryView({ profile, session, items, signedUrls, reload, isAdmin }: { profile: Profile; session: Session; items: GalleryItem[]; signedUrls: Record<string, string>; reload: () => Promise<void>; isAdmin: boolean }) {
